...
class HomeData {
  ...
  aboutUs(String aboutUs) async {
    var response =
        await crud.getData("${AppLink.aboutUs}?page_name=$aboutUs", {});
    return response.fold((l) => l, (r) => r);
  }
  ...
  Future getNotificationData(String token) async {
    var response = await crud.getData(AppLink.notification, {}, token: token);
    return response.fold((l) => l, (r) => r);
  }
}
