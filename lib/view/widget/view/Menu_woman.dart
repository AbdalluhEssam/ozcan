...
class Un_dun_categories_of_woman extends StatelessWidget {
  ...
  const Un_dun_categories_of_woman(
      {super.key,
      this.basket,
...
class Delete_prodects extends StatelessWidget {
...
class Icon_delete extends StatelessWidget {
  final void Function()? ontap;
  final String photo;
  final Color col1;
  final Color col2;
